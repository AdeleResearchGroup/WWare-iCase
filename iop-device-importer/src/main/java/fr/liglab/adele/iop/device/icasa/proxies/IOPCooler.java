 ...
 *
 */
@FunctionalExtender(contextServices = {GenericDevice.class,Cooler.class,IOPService.class})
public class IOPCooler implements GenericDevice, Cooler, IOPService {
    ...
    @ContextEntity.State.Field(service = Cooler.class,state = Cooler.COOLER_POWER_LEVEL,directAccess=true, value="0.0")
